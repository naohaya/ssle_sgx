...
/* convert uint32_t into binary string */
...
/* convert uint64_t into binary string */
std::string uint64ToBinString(uint64_t num)
{
  std::bitset<64> binaryNum(num);
  std::string binaryString = binaryNum.to_string();
